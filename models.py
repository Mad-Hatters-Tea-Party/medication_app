...
class Prescription(Base):
    ...
    prescription_date_start: Mapped[Optional[DateTime]] = mapped_column(DateTime, nullable=True)
    prescription_date_end: Mapped[Optional[DateTime]] = mapped_column(DateTime, nullable=True)
    ...
    prescription_details: Mapped[List['PrescriptionDetail']] = relationship('PrescriptionDetail', back_populates='prescription', cascade='all, delete-orphan')
